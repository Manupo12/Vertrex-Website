...
// Contiene la historia, misión y valores de la empresa. Los comentarios añadidos
// explican la estructura y el propósito de cada sección sin modificar la lógica.
        ...
        <div className="bg-background text-foreground">
            ...
            <main className="isolate">
                <div className="relative pt-14">
                    {/* Elemento decorativo difuso en el fondo (solo visual) */}
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 sm:py-20">
                 <ScrollAnimationWrapper className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-16 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    ...
                    {/* Imagen relacionada con la misión (relleno responsivo) */}
            ...
            {/* SECCIÓN DE VALORES */}
             <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 lg:px-8">
                ...
                <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                    {/* Iterar y mostrar cada valor/ principio definido en /lib/about-data */}
                    {values.map((value) => (
            ...
            {/* Sección final: llamada a la acción para contactar */}
