...
export function WhatsAppButton() {
  // Número de teléfono (formato E.164 sin '+' para wa.me)
  const phoneNumber = '573202070445';
  // Mensaje inicial que se precompleta en la conversación de WhatsApp
  const message = 'Hola, estoy interesado en los servicios de Vertrex.';

  // Construcción de la URL de wa.me con texto codificado
  ...
  return (
    ...
    <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50">
      ...
      >
        {/* Icono SVG de WhatsApp embebido (para no depender de librerías extra) */}
